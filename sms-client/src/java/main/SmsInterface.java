...
public interface SmsInterface {
    ...
    */
    ...
    /*
        Inputs dname - domain name
               sname, values - secret name and list of key value pairs
        Output - none
        Return SmsResponse object
            success or failure
            response code if connection succeeded, otherwise -1
    ...
    */
    public SmsResponse storeSecret(String dname, Map<String, Object> values);
    ...
    */
    public SmsResponse retrieveSecret(String dname, String sname);
